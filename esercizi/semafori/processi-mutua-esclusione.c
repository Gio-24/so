            ...
            int qta_elementi)
{
    ...
    Wait_Sem(sem_id, 0);// attesa per la sezione critica
    ...
    Signal_Sem(sem_id, 0); // rilascio della sezione critica
}
           ...
           int sem_id)
{
    ...
    {
        wait(NULL); // attende la terminazione di uno qualunque dei figli
    }
